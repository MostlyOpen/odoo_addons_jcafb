...
class SurveyQMD17RefreshWizard(models.TransientModel):
    _name = 'myo.survey.qmd17.refresh.wizard'
    ...
    @api.multi
    def do_survey_qmd17_refresh(self):
        self.ensure_one()

        survey_qmd17_model = self.env['myo.survey.qmd17']
        ...
        survey_qmd17_search = survey_qmd17_model.search([])
        survey_qmd17_search.unlink()
