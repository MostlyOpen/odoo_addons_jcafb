...
class SurveyQSI17RefreshWizard(models.TransientModel):
    _name = 'myo.survey.qsi17.refresh.wizard'
    ...
    @api.multi
    def do_survey_qsi17_refresh(self):
        self.ensure_one()

        survey_qsi17_model = self.env['myo.survey.qsi17']
        ...
        survey_qsi17_search = survey_qsi17_model.search([])
        survey_qsi17_search.unlink()
            ...
            if document_search.id is not False:
                ...
                if document_search.survey_id.title == self.survey_title:
                    ...
                    for person_reg in document_search.person_ids.person_id:
                        ...
                        QSI17_05_01 = self.get_value('QSI17_05_01', survey_user_input_reg)
                        QSI17_08_01 = self.get_value('QSI17_08_01', survey_user_input_reg)
