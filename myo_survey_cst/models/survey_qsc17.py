...
class SurveyQSC17(models.Model):
    _name = "myo.survey.qsc17"
    _log_access = False
    ...
    QSC17_03_01 = fields.Char(
        string='[QSC17_03_01]',
        help='Onde a criança fica quando não está na escola?'
    )
    QSC17_06_01 = fields.Char(
        string='[QSC17_06_01]',
        help='A criança já fez exame de fezes?'
    )
