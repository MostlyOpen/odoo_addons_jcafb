...
class SurveyQSI17(models.Model):
    _name = "myo.survey.qsi17"
    _log_access = False
    ...
    QSI17_05_01 = fields.Char(
        string='[QSI17_05_01]',
        help='Tem alguma dificuldade para:'
    )
    QSI17_08_01 = fields.Char(
        string='[QSI17_08_01]',
        help='O Sr(a) já fez exame de fezes?'
    )

    notes = fields.Text(string='Notes')
    active = fields.Boolean(
        'Active',
        help="If unchecked, it will allow you to hide the survey qsi17 without removing it.",
        default=1
    )
