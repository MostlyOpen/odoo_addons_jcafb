...
class SummaryPersonLabTestRequest(models.Model):
    _name = 'myo.summary.person.lab_test.request'
    ...
    active = fields.Boolean(
        'Active',
        help="If unchecked, it will allow you to hide the summary person lab test request without removing it.",
        default=1
    )
...
class Summary(models.Model):
    ...
    summary_person_lab_test_request_ids = fields.One2many(
        'myo.summary.person.lab_test.request',
        'summary_id',
        'Person Lab Test Requests'
    )
