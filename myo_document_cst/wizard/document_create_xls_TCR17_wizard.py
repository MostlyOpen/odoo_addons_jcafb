...
class DocumentCreateXlsTCR17Wizard(models.TransientModel):
    _name = 'myo.document.create_xls_tcr17.wizard'
    ...
    reference_file_path = fields.Char(
        ...
        default='/opt/openerp/mostlyopen_clvhealth_jcafb/data/TCR17/survey_jcafb_TCR17.xls'
    )

    @api.multi
    def do_document_create_xls_tcr17(self):
        self.ensure_one()
        ...
        for document_reg in self.document_ids:
            ...
            if document_reg.survey_id.title == '[TCR17]' and document_reg.state == 'draft':
                    ...
                    for document_person_2 in person_search.document_person_ids:
                        ...
                        if document_person_2.document_id.survey_id.title == '[QAN17]' and \
                           document_person_2.document_id.state == 'done':
                            ...
                            filepath = self.dir_path + '/TCR17_' + document_person.document_id.code + '.xls'
