...

{
    ...
    'data': [
        ...
        'views/lab_test_result_parasito_view.xml',
        'views/lab_test_result_swab_view.xml',
        'views/lab_test_result_urina_view.xml',
        ...
        'wizard/lab_test_anemia_dhc_transcribe_wizard_view.xml',
        'wizard/lab_test_parasito_swab_import_wizard_view.xml',
        'wizard/lab_test_parasito_swab_check_wizard_view.xml',
        'wizard/lab_test_parasito_swab_validate_wizard_view.xml',
        'wizard/lab_test_parasito_swab_transcribe_wizard_view.xml',
        ...
        'wizard/lab_test_result_parasito_refresh_wizard_view.xml',
        'wizard/lab_test_result_swab_refresh_wizard_view.xml',
        'wizard/lab_test_result_urina_refresh_wizard_view.xml',
        'views/lab_test_menu_view.xml',
        'views/lab_test_result_menu_view.xml',
    ],
    'demo': [],
    'test': [],
    'init_xml': [],
