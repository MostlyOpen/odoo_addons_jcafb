...
class LabTestResultSwab(models.Model):
    _name = "myo.lab_test.result.swab"
    _log_access = False
    ...
    active = fields.Boolean(
        'Active',
        help="If unchecked, it will allow you to hide the lab test result swab without removing it.",
        default=1
    )
